...
###################################
#    bash <(curl -Lso- https://ghproxy.com/https://raw.githubusercontent.com/tanst/scripts/master/ssh_key.sh)
###################################
apt-get update -y
...
mkdir -p ~/.ssh
curl -s https://ghproxy.com/https://github.com/tanst.keys > ~/.ssh/authorized_keys
